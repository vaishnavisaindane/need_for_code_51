...
<nav>
	 ...
	 <ul>
	 	<div style="display: inline-block ; color: white; font-size: 20px;height: 40px; "><li>{{Session::get('email')}}</li></div>
...
<div >
	<iframe src="/stu_livetable" name="frame" class="data" scrolling="none" style="height: 100vh;">
