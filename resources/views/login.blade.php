   ...
   <table >
    ...
    <th>
     <h5 style="color: lightseagreen;margin:0; margin-left: 100px ;font-family: 'Cormorant SC', serif;font-size: 55px;">ANCV School </h5> 
       ...
       <h4 style="margin-left: 115px; color: rgb(58, 58, 172);">Login into your account</h4> 
      

      <form action="login_sub" class="database_operation" >
      {{ csrf_field() }}


        <div class="form-row ml-5">
          <div class="col-lg-7">
            <input type="text" placeholder="Username" name="roll" class=" abc"><br>
              @error('roll')
        ...
        <div class="form-row ml-5">
          <div class="col-lg-7">
            <input type="password" placeholder="Password" name="login_pass" class=" abc"><br>
